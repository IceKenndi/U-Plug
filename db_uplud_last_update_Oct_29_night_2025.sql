...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2025 at 01:29 PM
...
(85, 'Test', 'halo', 'STU-34-CITE', 'official', 'CITE', '2025-10-29 12:20:15', NULL, 1, 'CITE Student - Kenneth Dela Cruz posted a new official post!');
...
(28, 'STU-28-COL', 'Khezy Lee Calacsan', 'Khezy Lee', 'Calacsan', 'khes.calacsan.up@phinmaed.com', '$2y$10$phdLCGGq4PlUumGJLzTy.eTWIk0Anvy90Rb9Nw1arHjmjNNYNKuAi', 'COL', 'assets/images/student-profiles/CITE/STU-28-CITE.png', 1, '23fc36aee5c4c8d470db0b638d6c86c0b95db86326ac6082c60b7d7375daaf88', 1761684062),
(34, 'STU-34-CITE', 'Kenneth Dela Cruz', 'Kenneth', 'Dela Cruz', 'keli.delacruz.up@phinmaed.com', '$2y$10$LF7T7UygOH4xQz.WBSwDY.EPC1FAw2cYaha8ENYJMCZjvVXSYT8aq', 'CITE', 'assets/images/student-profiles/CITE/STU-34-CITE.png', 1, NULL, NULL);
...
--
ALTER TABLE `student_users`
  MODIFY `seq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
